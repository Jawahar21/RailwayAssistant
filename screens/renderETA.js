...
class ETA extends Component{
  ...
  constructor(props){
    ...
    if ( props.item.item.queryResult.action == 'ETA_delayed_response' ||
         ...
         props.item.item.queryResult.action == 'ETA_actionItems_input' ) {
    ...
    if ( props.item.item.queryResult.action == 'ETA_station_input.ETA_station_input-custom' ||
         ...
         props.item.item.queryResult.action == 'ETA_actionItems_input.ETA_autocomplete_train_station' ){
  ...
  render(){
    ...
    if ( item.item.queryResult.action == 'ETA_delayed_response' ||
         ...
         item.item.queryResult.action == 'ETA_actionItems_input' ){
    ...
    if ( item.item.queryResult.action == 'ETA_station_input.ETA_station_input-custom' ||
         ...
         item.item.queryResult.action == 'ETA_actionItems_input.ETA_autocomplete_train_station' ){
