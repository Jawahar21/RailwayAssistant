...
class TrainStatus extends Component {
  ...
  constructor(props){
    super(props)
    if ( props.item.item.queryResult.action == 'train_status_main' ||
         props.item.item.queryResult.action == 'train_status_delayed_response' ||
         props.item.item.queryResult.action == 'train_status_actionItem_input' ){
    ...
    if ( props.item.item.queryResult.action == 'train_status.train_number_input' ||
         props.item.item.queryResult.action == 'train_status_actionItem_input.train_status_number_input' ){
  ...
  render(){
    ...
    if ( item.item.queryResult.action == 'train_status_main' ||
         item.item.queryResult.action == 'train_status_delayed_response' ||
         item.item.queryResult.action == 'train_status_actionItem_input' ) {
    ...
    if ( item.item.queryResult.action == 'train_status.train_number_input' ||
         item.item.queryResult.action == 'train_status_actionItem_input.train_status_number_input' ){
